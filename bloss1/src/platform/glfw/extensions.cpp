...
void APIENTRY
debug_callback(GLenum source, GLenum type, GLuint, GLenum severity, GLsizei, const GLchar *message, const void *)
{
    if (source == GL_DEBUG_SOURCE_OTHER_ARB || type == GL_DEBUG_TYPE_OTHER_ARB)
    {
        return;
    }  // Hide 'Other'
